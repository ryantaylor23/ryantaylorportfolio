  ...
  <div className="content">
    ...
    <div className="skills text-center">
      <ul className="d-inline-block text-left">
        <li className="h3 mb-3">Proficient in HTML5 and CSS3</li>
        <li className="h3 mb-3">Proficient in SCRUM and Agile</li>
        <li className="h3 mb-3">
          &nbsp;&nbsp;Experience with Bootstrap, Vue,
          <br />
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;React, Svelte, C#,
          JavaScript, JQuery
        </li>
        <li className="h3 mb-3">Excellent Communication</li>
        <li className="h3 mb-3"> Management Experience</li>
        <li className="h3">Problem-Solving, Very Detail Oriented</li>
      </ul>
    </div>
